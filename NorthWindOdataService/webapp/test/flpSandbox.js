		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NorthWindOdataService",
									"targetURL": "#NorthWindOdataService-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"NorthWindOdataService-display": {
								"semanticObject": "NorthWindOdataService",
								"action": "display",
								"description": "NorthWindOdataService",
								"title": "NorthWindOdataService",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.vesi.NorthWindOdataService",
									"url": sap.ui.require.toUrl("com/vesi/NorthWindOdataService")
								}
							}
						}
					}
