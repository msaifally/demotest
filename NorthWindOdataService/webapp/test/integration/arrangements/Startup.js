sap.ui.define([
	"sap/ui/test/Opa5",
	"com/vesi/NorthWindOdataService/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.vesi.NorthWindOdataService.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.vesi.NorthWindOdataService",
					async: true
				},
				hash: oOptions.hash,
